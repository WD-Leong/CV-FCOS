...
def train(
    ...
    for step in range(st_step, max_steps):
        ...
        for tmp_idx in batch_sample:
            ...
            # Overwrite the class ID. #
            class_id = np.zeros_like(class_id)
...
# Load the data. #
tmp_path  = \
    "C:/Users/admin/Desktop/Data/WiderPerson/"
data_file = tmp_path + "people_data.pkl"
...
with open(data_file, "rb") as tmp_load:
    train_data.extend(pkl.load(tmp_load))
