...
from tf_ver2_fcos import fcos_attention
...
train_loss = \
    model_path + "coco_losses_fcos_attn_resnet101.csv"
ckpt_model = model_path + "coco_fcos_attn_resnet101"
restore_flag = True
...
fcos_model = fcos_attention.FCOSAttn(
    num_classes, img_dims, box_scale, 
    label_2_id, n_layers=n_layers, 
    n_heads=n_heads, d_model=d_model, 
    d_ffwd=d_ffwd, backbone_model="resnet101")
model_optimizer = tf.optimizers.SGD(momentum=0.9)

print("-" * 50)
print("FCOS Attention Network Built.")
...
train(
    ...
    st_step, max_steps, min_lr=min_lr, step_save=50, 
